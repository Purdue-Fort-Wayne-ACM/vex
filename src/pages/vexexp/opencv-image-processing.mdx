...
white image might have pixels with values from 0 (completely black) to 255 (completely white). Color images use three channels - Red, Green,
and Blue (RGB) - with each channel having values from 0 to 255.
