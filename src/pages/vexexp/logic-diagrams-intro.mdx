...
diagram outlined. More serious programs make this more beneficial however, like consider this diagram:
...
It's a lot even with the diagram, but it'd be worse if it were just code - even if it were a simplified psuedocode. One would typically use a
